...
const buildLinkedInAuthUrl = () => {
  const params = new URLSearchParams({
    ...
    redirect_uri: `${window.location.origin}/oauth/callback/linkedin`,
...
const providers: OAuthProvider[] = [
  {
    ...
    bgClass: "bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200",
    hoverClass: "hover:bg-slate-50 dark:hover:bg-slate-700",
  },
  {
    id: "github",
    label: "GitHub",
    ...
    bgClass: "bg-slate-900 dark:bg-slate-800 border border-slate-900 dark:border-slate-700 text-white",
    hoverClass: "hover:bg-slate-800 dark:hover:bg-slate-700",
  },
  {
    id: "linkedin",
    label: "LinkedIn",
    ...
    bgClass: "bg-[#0A66C2] border border-[#0A66C2] text-white",
        ...
        {providers.map((provider) => (
          <button
            ...
            className={`
              ...
              ${provider.bgClass} ${provider.hoverClass}
